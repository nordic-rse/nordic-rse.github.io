...
complexities with every step and students further develop their code. They want
to start a repository with these toy examples.
...
software](https://bssw-tutorial.github.io/), "universe-hpc" and "intersect" to
discuss how to work together and exchange experiences/helpers/materials. We
agreed that it is crucial for sustainability of all the awesome stuff that came
