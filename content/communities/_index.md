...
We have a small but growing community distributed across the Nordic
countries (and even beyond).


## RSE groups in Nordic countries

To create a Nordic network of RSEs, we are interested in listing RSE
groups, teams, and local communities.  They may be based in (for
example) universities, national labs, research institutes, academic
departments, or university IT organisations.  If you are organized in
such a group or would like to be added here, please contact us.
...
To add yourself, please read our [map
documentation](https://github.com/nordic-rse/map/blob/main/README.md).


### Privacy

See the [repository's readme](https://github.com/nordic-rse/map#privacy).
